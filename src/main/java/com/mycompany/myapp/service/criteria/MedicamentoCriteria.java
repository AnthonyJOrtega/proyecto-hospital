...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.Medicamento} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.MedicamentoResource} to receive all the possible filtering options from
...
public class MedicamentoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nombre, descripcion, dosis, recetaId, distinct);
    }
