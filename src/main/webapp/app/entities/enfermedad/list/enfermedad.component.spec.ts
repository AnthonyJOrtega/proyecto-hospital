...
import { sampleWithRequiredData } from '../enfermedad.test-samples';
...
describe('Enfermedad Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.enfermedads()[0]).toEqual(expect.objectContaining({ id: 11813 }));
  });

  describe('trackId', () => {
    it('should forward to enfermedadService', () => {
      const entity = { id: 11813 };
      jest.spyOn(service, 'getEnfermedadIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEnfermedadIdentifier).toHaveBeenCalledWith(entity);
