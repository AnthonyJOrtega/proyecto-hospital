...
import { sampleWithRequiredData } from '../informe.test-samples';
...
describe('Informe Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.informes()[0]).toEqual(expect.objectContaining({ id: 15736 }));
  });

  describe('trackId', () => {
    it('should forward to informeService', () => {
      const entity = { id: 15736 };
      jest.spyOn(service, 'getInformeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getInformeIdentifier).toHaveBeenCalledWith(entity);
